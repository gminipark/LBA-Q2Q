...
def QA(image_id, ambiguous_question, ambiguous_entity, entity_id, ambiguous_question_answer):
    ...
    text1 = f"""USER: {ambiguous_question} Answer only in one or two words.
ASSISTANT:"""
    ...
    try:
        ...
        generated_text = tokenizer.decode(pred.cpu()[0], skip_special_tokens=False)

        return generated_text[0], text1, ambiguous_question_answer
